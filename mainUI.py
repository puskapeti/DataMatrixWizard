...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_hatch_preview = QtWidgets.QLabel(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_hatch_preview.sizePolicy().hasHeightForWidth())
        self.label_hatch_preview.setSizePolicy(sizePolicy)
        self.label_hatch_preview.setMinimumSize(QtCore.QSize(150, 150))
        self.label_hatch_preview.setMaximumSize(QtCore.QSize(150, 150))
        self.label_hatch_preview.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.label_hatch_preview.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_hatch_preview.setObjectName("label_hatch_preview")
        self.verticalLayout_6.addWidget(self.label_hatch_preview)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_hatch_preview.setText(_translate("MainWindow", "hatch_preview"))
